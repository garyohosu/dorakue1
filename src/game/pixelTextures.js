...
function drawTower(ctx) {
  drawGrass(ctx);
  rect(ctx, 6, 25, 20, 4, '#6a655d');
  rect(ctx, 9, 10, 14, 17, '#b9b6a8');
  rect(ctx, 7, 7, 18, 5, '#838a91');
  rect(ctx, 11, 4, 10, 4, '#d8d6c6');
  rect(ctx, 13, 13, 6, 5, '#4f6473');
  rect(ctx, 14, 21, 4, 6, '#2b3038');
